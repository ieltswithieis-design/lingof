// Script to generate high-fidelity, authentic, non-repetitive IELTS Listening and Reading data
// Every part has its own audio script, and questions follow the exact chronological order of the audio.
const fs = require('fs');
const path = require('path');

const existingData = JSON.parse(fs.readFileSync(path.join(__dirname, '../src/data/ieltsData.json'), 'utf8'));

// We will construct 20 comprehensive Listening Tests
// Each test has 4 parts, each part with 10 questions (40 questions total per test)
// Strict chronological audio order: Q1 to Q10 in Part 1, Q11 to Q20 in Part 2, Q21 to Q30 in Part 3, Q31 to Q40 in Part 4.

const listeningTestsSpecs = [
  {
    id: 1,
    title: "IELTS Listening Test 1 • Adventure Travel & Environmental Science",
    part1: {
      topic: "River Valley Wildlife Kayak Tour Booking",
      script: `Official IELTS Listening Practice. Part 1. You will hear a conversation between a customer and an adventure tour booking agent. First, you have some time to look at questions 1 to 5.
[pause]
...
Agent: Excellent choice! That's one of our most popular guided excursions. Before we check availability, could I take your full name, please?
...
Agent: Great, 07700 900342. Now, which day are you planning to do the kayak tour? We run sessions on Saturday and Sunday.
...
Customer: Superb, let me give you the card details now...`,
      questions: [
        ...
        { type: "completion", q: "Preferred day of the tour: ______", answer: "Saturday" },
        { type: "completion", q: "Total number of people in the group: ______", answer: "4 | four" },
        { type: "completion", q: "Selected departure time: ______", answer: "9:30 am | 9.30 am | 9:30 | 9.30" },
        { type: "completion", q: "Item provided to all participants: buoyancy vest and waterproof ______", answer: "jacket" },
        { type: "completion", q: "Item customers should bring themselves: waterproof ______", answer: "dry bag | bag" },
        { type: "completion", q: "Meeting place on Saturday: ______ Car Park", answer: "Mill Bridge" },
        { type: "completion", q: "Discounted rate for teenagers: £______ per person", answer: "25 | 25 pounds | £25" },
    ...
    part2: {
      ...
      script: `Part 2. You will hear a park warden giving an orientation talk to new visitors at the Oakwood Woodland and Nature Reserve. First, you have some time to look at questions 11 to 20.
[pause]
Listen carefully and answer questions 11 to 20.

Warden: Good morning, everyone, and a warm welcome to Oakwood Nature Reserve! My name is Claire Jenkins, and I'm the senior reserve warden here. Before you set off exploring our two hundred hectares of native ancient woodland, let me share some essential orientation details.
...
Finally, guided ranger walks run every Tuesday and Saturday at 11:00 am, departing from the sundial lawn just outside the café. These walks are completely free of charge, but places are capped at twenty people, so please sign up at the information desk. Thank you for your attention, and enjoy your day at Oakwood!`,
      questions: [
        {
          ...
          options: ["Protecting red squirrels and wetland birds", "Breeding rare species of deer", "Planting commercial timber forests", "Reintroducing wild wolves"],
          answer: 0
        },
        {
          type: "mcq",
        ...
        },
        {
          ...
          options: ["Dogs are completely prohibited", "Dogs must be on a lead of two metres or less", "Dogs can roam free on the Blue Trail", "Dogs are only permitted inside the café garden"],
          answer: 1
        },
    ...
    part3: {
      ...
      script: `Part 3. You will hear two architecture students, Emma and Jack, discussing their renewable building design assignment with their course supervisor, Professor Davies. First, you have some time to look at questions 21 to 30.
[pause]
...
Emma: Understood, professor. We'll finalize the reverberation calculations by this Wednesday. Thank you for your feedback!`,
    ...
    part4: {
      topic: "Academic Lecture on Bio-acoustics and Bat Echolocation Systems",
      script: `Part 4. You will hear an academic lecture given by a biologist on the bio-acoustics and navigation mechanisms of echolocating bats. First, you have some time to look at questions 31 to 40.
[pause]
Listen carefully and answer questions 31 to 40.

Lecturer: Good afternoon, students. Today we continue our module on sensory biology by examining one of nature's most sophisticated biosonar systems: ultrasonic echolocation in microbats, or microchiroptera.
...
console.log("Listening test 1 specification structured cleanly!");
