...
export const CertificateVerificationPortal: React.FC<CertificateVerificationPortalProps> = ({
  ...
  const runAccuracyScan = async (detectedCode: string | null) => {
    ...
    setScanProgress(45);
    setScanStep("Validating alternating odd/even alphanumeric sequence & embedded personal tokens...");
  ...
  const handleSearchVerify = async (
    ...
    setVerificationResult(null);
    setScanProgress(25);
    setScanStep("Analyzing alternating odd/even alphanumeric sequence...");
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-500/30 border border-blue-400/40 px-3 py-0.5 text-xs font-bold text-blue-200 uppercase tracking-wide">
                <ShieldCheck className="h-3.5 w-3.5 text-emerald-400" />
                Institutional Pattern Accuracy Verification
              </span>
              <span className="text-xs text-slate-300">Privacy-First Credential Protocol</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-white">
              Official TRF Accuracy Verification
            </h1>
            <p className="mt-2 text-sm text-slate-300 max-w-2xl leading-relaxed">
              Verify candidate test credentials directly against our secret mathematical odd/even cryptographic pattern. Enter the TRF code, candidate identity details, and claimed band scores (accepts <strong>8</strong>, <strong>8.0</strong>, or any format) to confirm authenticity.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <span className="text-[9px] text-slate-400 mt-0.5 block">
                    Odd pattern letters checked against name
                  </span>
                </div>
                ...
                <div>
                  ...
                  />
                  <span className="text-[9px] text-slate-400 mt-0.5 block">
                    Even pattern digits checked against ID
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="lg:col-span-6">
          {isScanning ? (
            ...
            <VerificationDossierCard result={verificationResult} />
          ) : (
      ...
      <div className="border-t border-slate-200 pt-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-[11px]">
          ...
          <div className="flex items-center gap-1.5 text-slate-700">
            ...
            <span>Odd/Even Alphanumeric Sequence</span>
          </div>
