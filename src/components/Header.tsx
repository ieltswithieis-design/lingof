  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur-md">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <div className="flex items-center gap-1.5">
            ...
            <span className="font-semibold text-white">
              Official IELTS Academic Testing
            </span>
      ...
      {/* =========================================================
          ...
          ========================================================= */}
      <div className="hidden lg:flex mx-auto max-w-7xl flex-col px-3 sm:px-6">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            {canGoBack && onBack && (
              <motion.button
                ...
                className="group flex shrink-0 items-center gap-1.5 rounded-xl border border-slate-300 bg-white px-3 py-1.5 text-xs font-black text-slate-800 shadow-2xs hover:border-blue-400 hover:bg-blue-50/50 hover:text-blue-900 transition cursor-pointer"
              >
        ...
        {/* =======================================================
            ...
            FLEX WRAP PREVENTS ITEMS FROM DISAPPEARING
            ======================================================= */}
        <div className="w-full border-t border-slate-100 py-2">

          <nav className="flex w-full flex-wrap items-center justify-center gap-1.5">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              onClick={() => handleNavClick("dashboard")}
              className={`flex shrink-0 items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-bold transition-colors cursor-pointer ${
            ...
            <motion.button
              ...
              className={`flex shrink-0 items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-black transition-all cursor-pointer ${
            ...
            <motion.button
              ...
              className={`flex shrink-0 items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-bold transition-all cursor-pointer ${
                currentTab === "blog"
            ...
            >
              ...
              <span className="rounded bg-red-600 px-1 py-0.5 text-[9px] font-black text-white">
                Hot
              </span>
            </motion.button>
            ...
            {/* ===================================================
                TRF
                NOW PART OF THE SECOND ROW
                =================================================== */}
            <motion.button
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.96 }}
              onClick={() => handleNavClick("certificate")}
              className={`flex shrink-0 items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-extrabold transition-all border cursor-pointer ${
            ...
            {/* ===================================================
                DIRECT VERIFICATION
                NOW ALWAYS VISIBLE ON DESKTOP
                =================================================== */}
            <motion.button
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.96 }}
              onClick={() => handleNavClick("verify")}
              className={`flex shrink-0 items-center gap-1.5 rounded-lg border px-3 py-2 text-xs font-extrabold transition-all cursor-pointer ${
                currentTab === "verify"
      ...
      <div className="flex lg:hidden items-center justify-between px-3 py-2 border-b border-slate-100 bg-white">
        ...
        <div className="flex items-center justify-center flex-1 px-1">
          ...
          >
            ...
            <div
              className={`relative flex items-center gap-2 rounded-full px-3 py-1.5 text-xs font-black transition-colors ${
                isMobileMenuOpen
              ...
              <div className="flex flex-col justify-center items-center gap-0.5 w-3.5 h-3">
                ...
                <span
                  className={`h-0.5 bg-white rounded-full transition-all duration-300 ${
                    isMobileMenuOpen
                      ? "w-3.5 rotate-45 translate-y-1"
                      : "w-3.5"
                  }`}
                />

                <span
                  className={`h-0.5 bg-amber-400 rounded-full transition-all duration-200 ${
                    isMobileMenuOpen
                      ? "w-0 opacity-0"
                      : "w-2.5 self-start"
                  }`}
      ...
      {/* =========================================================
          QUICK HORIZONTAL SCROLL PILLS FOR MOBILE
          ========================================================= */}
      ...
      {/* =========================================================
          FULL-SCREEN IMMERSIVE HAMBURGER MENU
          ========================================================= */}
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-5 space-y-6 max-w-4xl mx-auto w-full">
              ...
              {canGoBack && onBack && (
                ...
                >
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <span>
                      Return to Previous Screen / Test Catalog
                    </span>
                  </div>
              ...
              {/* PARTNER ORGANIZATION ANNOUNCEMENT */}
              ...
              {/* =====================================================
                  SECTION 3: OFFICIAL TRF & VERIFICATION
                  ===================================================== */}
              <div className="space-y-2">
