  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur-md">
      ...
      <div className="hidden lg:flex flex-col">
        ...
        {/* Row 2: TRF and options on the right side of it + Menu Hub for PC */}
        <div className="border-t border-slate-200/80 bg-slate-50/80 py-1.5 px-3 sm:px-6">
          <div className="mx-auto max-w-7xl flex items-center justify-between">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <motion.button
                ...
                className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-extrabold transition-all border cursor-pointer ${
              ...
              <motion.button
                ...
                className={`flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-xs font-extrabold transition shadow-2xs cursor-pointer ${
                  currentTab === "verify"
              ...
              <motion.button
                ...
                className="relative group rounded-full p-[1.5px] bg-gradient-to-r from-red-600 via-amber-500 to-blue-600 shadow-xs transition-all cursor-pointer ml-1"
                title="Open Complete Menu Hub & IELTS Navigation Portal"
              >
                <div className={`relative flex items-center gap-2 rounded-full px-3 py-1 text-xs font-black transition-colors ${
                  isMobileMenuOpen 
                  ...
                  <span className="text-[11px] font-black uppercase tracking-wider text-amber-200">
                    {isMobileMenuOpen ? "Close Hub" : "Menu Hub"}
                  </span>
                  <span className="rounded-full bg-blue-500/30 px-1.5 py-0.2 text-[9px] font-extrabold text-blue-200 border border-blue-400/30">
                    20 Mocks & Hub
                  </span>
                </div>
              </motion.button>
            ...
            {/* Right side: Completion Meter & Reset Progress */}
            <div className="flex items-center gap-2.5">
              {/* Completion Meter */}
              <div className="flex items-center gap-2 rounded-xl bg-white px-2.5 py-1 text-xs font-medium text-slate-700 border border-slate-200/80 shadow-2xs">
                <span className="text-[11px] font-bold text-slate-500">Finished:</span>
              ...
              {completedCount > 0 && (
                <motion.button
                  ...
                  className="rounded-lg p-1.5 text-slate-400 hover:bg-white hover:text-slate-700 border border-transparent hover:border-slate-200 transition-colors cursor-pointer"
                >
