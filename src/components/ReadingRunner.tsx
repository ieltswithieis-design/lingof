...
import { Clock, CheckCircle, ArrowLeft, ArrowRight, RotateCcw, Award, CheckCircle2, XCircle, Flag, ZoomIn, ZoomOut, Sparkles } from "lucide-react";
            ...
            <div className="flex items-center justify-between gap-3 border-t border-slate-100 pt-3">
              ...
              <div className="flex items-center gap-2">
                ...
                {activePassage < 2 ? (
                  ...
                  >
                    <span>Save Passage {activePassage + 1} & Next</span>
                  ...
                  >
                    ...
                    <span>Submit & Finish Reading Test</span>
                  </button>
                )}
              </div>
            </div>
